...
void main_kernel_inner(global_addr_t v1, global_addr_t v2, global_addr_t v3, global_addr_t v4, global_addr_t v5, global_addr_t v6, global_addr_t v7, global_addr_t v8, global_addr_t v9, global_addr_t v10, global_addr_t v11, global_addr_t v12, global_addr_t v13, global_addr_t v14, global_addr_t v15, global_addr_t v16, global_addr_t v17) {
  ...
  __ppl_tensor_info v31 = {.shape = {1, 64, 1, 512} , .stride = {0}, .addr = v14, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 65536, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info v29 = {.shape = {1, 4, 1, 1} , .stride = {0}, .addr = v12, .dtype = DT_UINT32, .mode = 2, .align_mode = 0, .size = 16, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info v32 = {.shape = {1, 64, 1, 64} , .stride = {0}, .addr = v15, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 8192, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info v23 = {.shape = {1, 64, 1, 512} , .stride = {0}, .addr = v6, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 65536, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info v24 = {.shape = {1, 64, 1, 64} , .stride = {0}, .addr = v7, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 8192, .unsigned_flag = 0, .default_stride = true};
  ...
  for (int by = __pla_h_begin; by < __pla_h_end; ++by) {
    ...
    if (__pla_block_idx == 0 && by == __pla_h_begin) {
      ...
      {
      dim4 __gather_block_shape = {1, 1, 4, 8192};
      tpu_gdma_h_gather_S2S(v31.addr, v23.addr, v29.addr, false, (scalar_t){.u32 = 0}, &__gather_block_shape, 4, NULL, NULL, NULL, DT_BFP16);
      }
      {
      dim4 __gather_block_shape = {1, 1, 4, 1024};
      tpu_gdma_h_gather_S2S(v32.addr, v24.addr, v29.addr, false, (scalar_t){.u32 = 0}, &__gather_block_shape, 4, NULL, NULL, NULL, DT_BFP16);
      }
    }
    if (by == __pla_h_begin) {
      tpu_sync_core();
    ...
    __ppl_tensor_info kv_gather = {.shape = {1, 32, 1, 512} , .stride = {32768, 512, 512, 1} , .addr = v31.addr + ((0) * 512+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((0) * 512+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
    ...
    __ppl_tensor_info pe_gather = {.shape = {1, 32, 1, 64} , .stride = {4096, 64, 64, 1} , .addr = v32.addr + ((0) * 64+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((0) * 64+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
    ...
    __ppl_tensor_info kv_gather_1 = {.shape = {1, 32, 1, 512} , .stride = {32768, 512, 512, 1} , .addr = v31.addr + ((32) * 512+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((32) * 512+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
    ...
    __ppl_tensor_info pe_gather_1 = {.shape = {1, 32, 1, 64} , .stride = {4096, 64, 64, 1} , .addr = v32.addr + ((32) * 64+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((32) * 64+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
